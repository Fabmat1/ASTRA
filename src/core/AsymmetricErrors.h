...
// Draws from a two-piece normal: the up sigma above the central value, the down
// sigma below. This is how an asymmetric error bar is sampled in a Monte Carlo,
// and it is the only correct way to do so - averaging the two sides first
// throws away exactly the asymmetry the interval was recording.
