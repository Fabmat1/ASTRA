...
public:
    ...
    // True anomaly from eccentric anomaly. Written with the half-angle form
    // rather than acos, which loses precision near periapsis and apoapsis and
    // cannot recover the quadrant on its own.
