...
#include "fitting/ui/FitProgressDialog.h"
...
#include "fitting/ui/InteractiveIsisDialog.h"
#include "ui/widgets/CheckStateDragger.h"
...
FitSetupWidget::~FitSetupWidget()
{
    ...
    AppPaths::cleanupTempPaths(_queueTemps);
}
...
void FitSetupWidget::onRunFit()
{
    ...
    if (jobs.isEmpty()) {
        AppPaths::cleanupTempPaths(tempCleanup);
...
void FitSetupWidget::onPreviewScript()
{
    ...
    if (jobs.isEmpty()) {
        AppPaths::cleanupTempPaths(cleanup);
