...
private:
  ...
  QWidget *buildConstraintsTab();
  QWidget *buildDarkeningTab();
  QWidget *buildBeamingTab();
  QWidget *buildSolverTab();
  QWidget *buildRunTab();
  ...
  // Header
  QLabel *_hdr = nullptr;
  QComboBox *_bandCombo = nullptr;
  QLabel *_bandWl = nullptr;
