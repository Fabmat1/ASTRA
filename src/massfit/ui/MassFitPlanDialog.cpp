#include "massfit/ui/MassFitPlanDialog.h"
...
#include "massfit/ui/MassFitRuleEditor.h"
#include "fitting/ui/FitComponentsWidget.h"
...
using astra::clearLayout;
using astra::makeIntSpin;

// This dialog's parameter fields hold wider numbers than most - a resolution
// slope with six decimals over a +/-1e6 range - so they get a little more room
// than the shared 110 px default.
QDoubleSpinBox* makeDoubleSpin(double min, double max, int decimals, double val,
                               double step = 1.0, const QString& suffix = {})
{
    return astra::makeDoubleSpin(min, max, decimals, val, step, suffix, 120);
}
